...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  goToTaskList(): void {
    ...
    this.router.navigate(['/tasks']); // tu vista de lista (TaskListComponent)
  }
  
  goToTaskBoard(): void {
  this.showTasksMenu = false;
  // Aquí necesitas un projectId. Si tienes una vista "todas las tareas" en Kanban
  // sin depender de un proyecto, crea una ruta tipo /tasks/board (ver punto 3)
